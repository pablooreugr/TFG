...
Donde $d_{observado}$ es la imagen que observamos en el telescopio, $d_{real}$ es el objeto extenso, y $p$ es la PSF del propio telescopio. Si miramos una imagen de ejemplo para este caso:
...
Donde la notación se indica de manera que si está en minúscula está en el dominio de las posiciones, y mayúscula estando en el dominio de las frecuencias espaciales.
