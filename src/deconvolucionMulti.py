...
# ESTE ARCHIVO SOLO CAMBIA LA PRIMERA FUNCION DONDE PARALELIZA LA FORMULA
...
def deconvolucionFourier_paralela(imagen, psf, epsilon=1e-15):
    ...
    # workers=-1 le dice que use el 100% de tu CPU
    G = sp_fft.fft2(imagen, axes=(2, 3), workers=-1)
...
datosArreglados = deconvolucionFourier_paralela(datos, mi_psf)
